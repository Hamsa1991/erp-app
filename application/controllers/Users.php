...
class Users extends MY_Controller {
	...
	public function index()
	{
		...
		$result = $this->user_service->list_all();
	...
	{
		$this->require_permission('manage_users');
		$result = $this->user_service->get($id);
	...
	public function create()
	{
		...
		$result = $this->user_service->create($this->get_json_input());
	...
	public function update($id)
	{
		...
		$result = $this->user_service->update($id, $this->get_json_input());
